...
const API_URL = "https://cantinho-do-mana.onrender.com";
...
function Tela() {
  ...
  return (
    <div className="app">
      ...
      {secao === "inicio" && <main className="inicio"><section className="hero"><div className="hero-conteudo"><span className="tag">sabor de casa</span><h1>Bem-vindo ao<br /><strong>Cantinho do Maná</strong></h1><p>Comida caseira feita com carinho, ingredientes selecionados e aquele sabor que faz você querer voltar.</p><button className="botao-principal" onClick={() => navegar("produtos")}>Ver nosso cardápio</button></div><div className="hero-detalhe"><div className="hero-circulo"></div><div className="hero-texto"><span>Comida</span><strong>DE CASA</strong></div></div></section></main>}
